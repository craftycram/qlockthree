...
static const WordMapping HOUR_WORDS[] = {
    {"ZWÖLF", 188, 10, false},
    {"EINS", 110, 8, false}, // Nutze Länge 6 für "EIN" bei "Es ist ein Uhr"
    {"ZWEI", 124, 8, false},
    {"DREI", 132, 8, false},
    {"VIER", 146, 8, false},
    {"FÜNF", 102, 8, false}, // Teilt sich das 'F' mit ELF
    {"SECHS", 154, 10, false},
    {"SIEBEN", 176, 12, false},
    {"ACHT", 168, 8, false},
    {"NEUN", 204, 8, false}, // Teilt sich das 'N' mit ZEHN
    {"ZEHN", 198, 8, false},
    {"ELF", 98, 6, false},
};
